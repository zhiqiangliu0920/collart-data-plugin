...
sources: ["web-channel", "ads-redlines", "team-collart_web-channel-attribution", "cursor-channels-attribution-md"]
...
来源摘录：[web-channel](../../provenance/excerpts/web-channel.txt)、[ads-redlines](../../provenance/excerpts/ads-redlines.txt)。原始路径、定位和哈希见 [来源清单](../../provenance/sources.json)。本条是 2026-09-12 的资料整理，未进行本次生产查询或业务负责人确认；当前可用性与未明确的细节需继续核验。
