---
id: "table:aidata2025.ads_collart.ads_oper_collart_template_data"
title: "aidata2025.ads_collart.ads_oper_collart_template_data"
project: "shared"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/ads_oper_collart_template_data.sqlx", "feishu:aidata2025.ads_collart.ads_oper_collart_template_data", "schema:aidata2025.ads_collart.ads_oper_collart_template_data"]
tags: ["ads_oper_collart_template_data", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collart.ads_oper_collart_template_data"]
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collart.ads_oper_collart_template_data` |
| 粒度 | 未说明 |
...
| `is_new` | STRING | NULLABLE | 未说明 | 缺口 |
| `temp_id` | STRING | NULLABLE | 未说明 | 缺口 |
| `show_uv` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `click_uv` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `ai_service_start_uv` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `ai_service_success_uv` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `save_uv` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `vip_uv` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `generate_watch_ad_num` | INTEGER | NULLABLE | 未说明 | 缺口 |
| `temp_ad_value` | FLOAT | NULLABLE | 未说明 | 缺口 |
| `subscribe_value` | FLOAT | NULLABLE | 未说明 | 缺口 |
| `template_value` | FLOAT | NULLABLE | 未说明 | 缺口 |
