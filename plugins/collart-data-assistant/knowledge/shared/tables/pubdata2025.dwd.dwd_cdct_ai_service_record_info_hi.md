---
id: "table:pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi"
title: "pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi · 用户ai服务使用明细表(服务端）"
project: "shared"
kind: "table"
status: "documented"
sources: ["dataform:pubdata/definitions/dwd/log/h_dwd_cdct_ai_service_record_info_hi.sqlx", "feishu:pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi", "schema:pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi"]
tags: ["dwd_cdct_ai_service_record_info_hi", "字段", "schema", "SQLX"]
tables: ["pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi"]
review_required: true
applies_to: ["collart_android", "collart_ios", "collart_web", "collart_fashion"]
---

# pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi · 用户ai服务使用明细表(服务端）
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `pubdata2025.dwd.dwd_cdct_ai_service_record_info_hi` |
| 粒度 | 每个调用任务id一行 |
| 主键/去重键 | task_id；BigQuery 未声明即不代表强制唯一约束 |
...
| `time_cost` | FLOAT | NULLABLE | 未说明 | 缺口 |
...
飞书登记上游（不保证当前依赖）：hzdw2024.ods.ai_base_record_store,hzdw2024.ods.ods_ai_record_info
