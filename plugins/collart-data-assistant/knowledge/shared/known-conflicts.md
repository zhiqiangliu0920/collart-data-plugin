...
verified_by: null
effective_from: null
sources: ["legacy-ios", "ads-routing", "legacy-conversion", "metrics", "revenue", "ads-redlines", "web-profile", "team-shared-known-conflicts"]
...
来源摘录：[legacy-ios](../../provenance/excerpts/legacy-ios.txt)、[ads-routing](../../provenance/excerpts/ads-routing.txt)、[legacy-conversion](../../provenance/excerpts/legacy-conversion.txt)、[metrics](../../provenance/excerpts/metrics.txt)、[revenue](../../provenance/excerpts/revenue.txt)、[ads-redlines](../../provenance/excerpts/ads-redlines.txt)、[web-profile](../../provenance/excerpts/web-profile.txt)。原始路径、定位和哈希见 [来源清单](../../provenance/sources.json)。本条是 2026-09-12 的资料整理，未进行本次生产查询或业务负责人确认；当前可用性与未明确的细节需继续核验。
