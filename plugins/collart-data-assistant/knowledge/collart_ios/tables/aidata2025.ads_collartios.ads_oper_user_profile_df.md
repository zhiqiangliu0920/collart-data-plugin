---
id: "table:aidata2025.ads_collartios.ads_oper_user_profile_df"
title: "aidata2025.ads_collartios.ads_oper_user_profile_df"
project: "collart_ios"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/collart_ios/ads_oper_user_profile_df.sqlx", "feishu:aidata2025.ads_collartios.ads_oper_user_profile_df", "schema:aidata2025.ads_collartios.ads_oper_user_profile_df"]
tags: ["ads_oper_user_profile_df", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collartios.ads_oper_user_profile_df"]
review_required: true
applies_to: []
---

# aidata2025.ads_collartios.ads_oper_user_profile_df
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collartios.ads_oper_user_profile_df` |
...
- 加工源码：`dataform:aidata/definitions/ads/collart/collart_ios/ads_oper_user_profile_df.sqlx`；仓库 `aidata`，路径 `definitions/ads/collart/collart_ios/ads_oper_user_profile_df.sqlx`，版本 `9af2cc4ed39c61edb920c7ceba68425d366924a8`，捕获 `2026-09-14T13:18:52.238802+00:00`。同一 SQLX 的产出：`aidata2025.ads_collartios.ads_oper_user_profile_df`。

源码说明摘录（保留原定义日期；不能当作本次运行验证）：

```text
Collart iOS 第三张表：用户生命周期画像（1 用户 1 行）
  Dataform: definitions/ads/collart/collart_ios/ads_oper_user_profile_df.sqlx
  目标表  : aidata2025.ads_collartios.ads_oper_user_profile_df
  ...
  与 Android 差异：
  - identity: adjust_id / clarity_user_id / advertising_id
  - traffic_src: name/type/platform + ASA 字段（medium/source/campaign_id/ad_group_id/keyword_id）
  - 收入：全部来自 active.revenue（Apple IAP + Stripe RUB 叠加）；无 dws 订阅/广告表；ad=0
  - Dataform action name 带 ads_collartios_ 前缀，避免与 Android 同文件名冲突
...
LEFT JOIN `aidata2025.ads_collartios.ads_oper_user_profile_df` AS p USING (user_pseudo_id)
...
- 物理上游：`aidata2025.ads_collartios.ads_oper_user_event_metric_di`
