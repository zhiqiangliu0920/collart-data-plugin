---
id: "table:aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di"
title: "aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di"
project: "collart_ios"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/collart_ios/ads_oper_basic_indicator_attr_di.sqlx", "feishu:aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di", "schema:aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di"]
tags: ["ads_oper_basic_indicator_attr_di", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di"]
review_required: true
applies_to: []
---

# aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di` |
| 粒度 | 未说明 |
...
- 加工源码：`dataform:aidata/definitions/ads/collart/collart_ios/ads_oper_basic_indicator_attr_di.sqlx`；仓库 `aidata`，路径 `definitions/ads/collart/collart_ios/ads_oper_basic_indicator_attr_di.sqlx`，版本 `9af2cc4ed39c61edb920c7ceba68425d366924a8`，捕获 `2026-09-14T13:18:51.444868+00:00`。同一 SQLX 的产出：`aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di`。

源码说明摘录（保留原定义日期；不能当作本次运行验证）：

```text
Collart iOS 第五张表：日 × 默认维度基础指标
  Dataform: definitions/ads/collart/collart_ios/ads_oper_basic_indicator_attr_di.sqlx
  目标表  : aidata2025.ads_collartios.ads_oper_basic_indicator_attr_di
  上游    : ads_collartios.ads_oper_user_active_di
