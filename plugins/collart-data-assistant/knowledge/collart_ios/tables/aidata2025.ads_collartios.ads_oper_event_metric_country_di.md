---
id: "table:aidata2025.ads_collartios.ads_oper_event_metric_country_di"
title: "aidata2025.ads_collartios.ads_oper_event_metric_country_di"
project: "collart_ios"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/collart_ios/ads_oper_event_metric_country_di.sqlx", "feishu:aidata2025.ads_collartios.ads_oper_event_metric_country_di", "schema:aidata2025.ads_collartios.ads_oper_event_metric_country_di"]
tags: ["ads_oper_event_metric_country_di", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collartios.ads_oper_event_metric_country_di"]
review_required: true
applies_to: []
---

# aidata2025.ads_collartios.ads_oper_event_metric_country_di
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collartios.ads_oper_event_metric_country_di` |
| 粒度 | 未说明 |
...
- 加工源码：`dataform:aidata/definitions/ads/collart/collart_ios/ads_oper_event_metric_country_di.sqlx`；仓库 `aidata`，路径 `definitions/ads/collart/collart_ios/ads_oper_event_metric_country_di.sqlx`，版本 `9af2cc4ed39c61edb920c7ceba68425d366924a8`，捕获 `2026-09-14T13:18:51.564424+00:00`。同一 SQLX 的产出：`aidata2025.ads_collartios.ads_oper_event_metric_country_di`。

源码说明摘录（保留原定义日期；不能当作本次运行验证）：

```text
Collart iOS：日 × 国家 事件指标汇总
  Dataform: definitions/ads/collart/collart_ios/ads_oper_event_metric_country_di.sqlx
  目标表  : aidata2025.ads_collartios.ads_oper_event_metric_country_di

  口径:
  - 粒度: event_date × country；全量国家（不 top_country）
  - 列名=metric_name 去 *_pv 后缀；STRUCT 内区分 uv/pv
  - 上游: 从表 9 aidata2025.ads_collartios.ads_oper_event_metric_attr_di 按 country SUM(uv/pv)
  - 列由 aidata2025.ads_collart.ads_dim_metric_rule is_materialized=true 驱动
    （本文件由 _scratch/gen_event_metric_country_sqlx_ios.py 产出，勿手改）
  - 与表 6 basic_indicator_country 并行：本表只管事件漏斗
...
```
- 物理上游：`aidata2025.ads_collartios.ads_oper_event_metric_attr_di`
