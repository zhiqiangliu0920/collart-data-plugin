---
id: "table:aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di"
title: "aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di"
project: "collart_fashion"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/collart_fashion/ads_oper_basic_indicator_attr_di.sqlx", "feishu:aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di", "schema:aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di"]
tags: ["ads_oper_basic_indicator_attr_di", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di"]
review_required: true
applies_to: []
---

# aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di` |
| 粒度 | 未说明 |
...
- 加工源码：`dataform:aidata/definitions/ads/collart/collart_fashion/ads_oper_basic_indicator_attr_di.sqlx`；仓库 `aidata`，路径 `definitions/ads/collart/collart_fashion/ads_oper_basic_indicator_attr_di.sqlx`，版本 `9af2cc4ed39c61edb920c7ceba68425d366924a8`，捕获 `2026-09-14T13:18:50.007406+00:00`。同一 SQLX 的产出：`aidata2025.ads_collartfashion.ads_oper_basic_indicator_attr_di`。
...
Collart Fashion 第五张表：日 × 默认维度基础指标
  ...
  - is_new：取上游 is_studio_new（当天进 /studio 且当天 first_visit）；收入补行 is_new=FALSE
  - 人群：is_studio_active 或 purchase_revenue>0（丢掉 SEO-only，保留收入补行）
  - DAU：只计 is_studio_active=TRUE
...
AND (IFNULL(is_studio_active, FALSE) OR IFNULL(revenue.purchase_revenue, 0) > 0)
