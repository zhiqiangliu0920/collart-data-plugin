---
id: "table:aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di"
title: "aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di"
project: "collart_web"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/collart_web/ads_oper_basic_indicator_daily_di.sqlx", "feishu:aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di", "schema:aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di"]
tags: ["ads_oper_basic_indicator_daily_di", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di"]
review_required: true
applies_to: []
---

# aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di` |
| 粒度 | 未说明 |
...
- 加工源码：`dataform:aidata/definitions/ads/collart/collart_web/ads_oper_basic_indicator_daily_di.sqlx`；仓库 `aidata`，路径 `definitions/ads/collart/collart_web/ads_oper_basic_indicator_daily_di.sqlx`，版本 `9af2cc4ed39c61edb920c7ceba68425d366924a8`，捕获 `2026-09-14T13:18:52.343184+00:00`。同一 SQLX 的产出：`aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di`。

源码说明摘录（保留原定义日期；不能当作本次运行验证）：

```text
Collart Web 第七张表：日总览（含事件漏斗）
  Dataform: definitions/ads/collart/collart_web/ads_oper_basic_indicator_daily_di.sqlx
  目标表  : aidata2025.ads_collartweb.ads_oper_basic_indicator_daily_di
  - 行为/留存/订阅/收入/花费: SUM(country)
  - 事件漏斗: SUM(event_metric_country)
  - revenue 无 trial_conver_revenue（2026-08-11 确认）
  - 本文件由 _scratch/gen_indicator_daily_sqlx_web_fashion.py 产出
```
