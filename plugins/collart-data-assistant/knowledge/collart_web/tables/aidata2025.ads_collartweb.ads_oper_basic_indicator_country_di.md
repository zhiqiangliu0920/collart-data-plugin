---
id: "table:aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di"
title: "aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di"
project: "collart_web"
kind: "table"
status: "documented"
sources: ["dataform:aidata/definitions/ads/collart/collart_web/ads_oper_basic_indicator_country_di.sqlx", "feishu:aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di", "schema:aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di"]
tags: ["ads_oper_basic_indicator_country_di", "字段", "schema", "SQLX"]
tables: ["aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di"]
review_required: true
applies_to: []
---

# aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di
...
| 项 | 定义及来源 |
|---|---|
| 物理表 | `aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di` |
| 粒度 | 未说明 |
...
- 加工源码：`dataform:aidata/definitions/ads/collart/collart_web/ads_oper_basic_indicator_country_di.sqlx`；仓库 `aidata`，路径 `definitions/ads/collart/collart_web/ads_oper_basic_indicator_country_di.sqlx`，版本 `9af2cc4ed39c61edb920c7ceba68425d366924a8`，捕获 `2026-09-14T13:18:52.259865+00:00`。同一 SQLX 的产出：`aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di`。

源码说明摘录（保留原定义日期；不能当作本次运行验证）：

```text
Collart Web 第六张表：日 × 国家基础指标
  目标表: aidata2025.ads_collartweb.ads_oper_basic_indicator_country_di
  - 行为: attr 按 country SUM
  - retain / rolling_retain：仅 is_new；retain2_* 为新增×VIP/渠道切片；观察窗未满置 NULL
  - 收入 revenue STRUCT: 全部直接取 ads_ad_sub_revenue_1h（package_name=collart_web）
      revenue ← revenue；purchase_revenue ← sub_revenue
      resub/new/credit/ad / *_subscribe_uv ← 同名字段；credit_pack_uv ← credit_uv
      ad_uv ← 0
  - 花费: dwd_cdct_delivery_cost_di，package_name=collart_web（ADS 层不用 ODS 的 collart-web）
```
...
AND a.package_name = 'collart_web'
GROUP BY a.event_date, country
LEFT JOIN beh AS b USING (event_date, country)
...
- 物理上游：`aidata2025.ads_collartweb.ads_oper_basic_indicator_attr_di`
